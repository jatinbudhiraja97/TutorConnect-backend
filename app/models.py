...
class User(db.Model):
    __tablename__ = 'users'  # Table name for User
...
class Student(db.Model):
    __tablename__ = 'students'  # Table name for Student
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)  # Primary Key
...
class Professor(db.Model):
    __tablename__ = 'professors'  # Table name for Professor
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)  # Primary Key
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False)
    name = db.Column(db.String(150), nullable=False)
...
class Booking(db.Model):
    __tablename__ = 'bookings'  # Table name for Booking
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)  # Primary Key
...
class Notification(db.Model):
    __tablename__ = 'notifications'  # Table name for Notification
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)  # Primary Key
    student_id = db.Column(db.Integer, db.ForeignKey('students.id'), nullable=False)
...
class Rating(db.Model):
    __tablename__ = 'ratings'  # Table name for Rating
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)  # Primary Key
    professor_id = db.Column(db.Integer, db.ForeignKey('professors.id'), nullable=False)
...
class Comment(db.Model):
    __tablename__ = 'comments'  # Table name for Comment
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)  # Primary Key
    professor_id = db.Column(db.Integer, db.ForeignKey('professors.id'), nullable=False)
